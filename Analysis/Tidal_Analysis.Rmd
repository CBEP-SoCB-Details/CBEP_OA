...
since high tide,e WITHOUT accounting for autocorrelation.
...
daily averages is zero, so there is no intercept term.
...
system.time(pco2_gam <- gamm(co2_corr_res ~  s(minssincehigh, by = Season, 
                                               bs='cc', k=6),
...
summary(ph_gam)
```
Allfour seasonal patterns are judged unlikely to be due solely to chance, but we 
